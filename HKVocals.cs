...
public class HKVocals: Mod, IGlobalSettings<GlobalSettings>, ILocalSettings<SaveSettings>, ICustomMenuMod
{
    ...
    public override void Initialize()
    {
        ...
        On.AnimatorSequence.Begin += MonomonIntro;
    ...
    private void MonomonIntro(On.AnimatorSequence.orig_Begin orig, AnimatorSequence self)
    {
        audioSource.transform.localPosition = new Vector2(Screen.width / 2,Screen.height / 2);
